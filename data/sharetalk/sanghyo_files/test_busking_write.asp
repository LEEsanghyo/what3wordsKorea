		...
		<script type="text/javascript">
            ...
            function write_upload() {
                ...
                if (title_input == "") {
                    ...
                    var user = "busking_master";
                    alert(title_input);
                    alert(content);
                    alert(latitude);
                    alert(longitude);
                    alert(busking_code);
		            var strurl = "test_send_write_daily.asp?file_upload_area_real=" + file_upload_area_real + "&title_input=" + title_input + "&content_input_area=" + content + "&latitude=" + latitude + "&longitude=" + longitude + "&code=" + busking_code + "&input_user=" + user;
