		...
		<script type="text/javascript">
            ...
            function write_upload() {
                ...
                if (title_input == "") {
                    ...
                    var user = "volunteer_master";
		            var strurl = "test_send_write_daily.asp?file_upload_area_real=" + file_upload_area_real + "&title_input=" + title_input + "&content_input_area=" + content + "&latitude=" + latitude + "&longitude=" + longitude +"&code=" + volunteer_code + "&input_user=" + user;
