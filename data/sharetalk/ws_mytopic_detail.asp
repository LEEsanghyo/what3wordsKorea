...
<input type="hidden" id="post_no" value="<%=post_no %>" >
    ...
    <% top_menu = "글공유" %>
    <!-- #include virtual="/_include/top_detail_mytopic.asp" -->
            ...
            <table class="main_table">
               <tr>
                ...
                <tr>
                    <td class="bbcDate">
                        <table style="width:100%;">
                            <tr><td width="8%" rowspan="2" valign="bottom" align="left"><img src="<%=logo_url %>" style="width:40px;height:40px;border-radius:20px;"/></td>
               ...
               <tr>
                ...
                <tr><td align="center">
                            <table style="width:100%;">
                                ...
                                <tr><td><span style="font-size:12px;color:#808080;">2017-03-20 오전 10:02:33</span></span>
                                    </td></tr>
                            </table>
                </td>
                </tr>
...
<div class="bottom">
    <table style="width:100%; height:40px; text-align: center; vertical-align: middle;background:#FFFFFF;">
        <tr><td colspan="4" style="border-style: solid; border-width: 1px; border-color: #CCCCCC;"></td></tr>
        <tr><td width="25%;" align="center" style="font-size:14px;font-family:Arial,맑은 고딕,돋움;border-right:solid 1px #CCCCCC;padding:10px;">
            ...
            <td width="25%;" align="center" style="font-size:14px;font-family:Arial,맑은 고딕,돋움;border-right:solid 1px #CCCCCC;padding:10px;">
                <a href="ws_mytopic_edit.asp?post_no=<%=post_no %>">글수정</a>
            </td>
